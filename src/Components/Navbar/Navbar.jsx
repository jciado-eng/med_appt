...
const Navbar = () => {
  // Stato per gestire l'apertura e la chiusura del menu mobile
  const [isActive, setIsActive] = useState(false);

  // Gestore del click per fare il toggle del menu e delle icone
  const handleClick = () => {
  ...
  return (
    <nav>
      ...
      {/* Il menu aggiunge o rimuove la classe 'active' dinamicamente */}
